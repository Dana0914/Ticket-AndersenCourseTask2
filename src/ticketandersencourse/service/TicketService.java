...
import ticketandersencourse.user.User;
...
public class TicketService {
    ...
    public static void main(String[] args) {
        ...
        ticket1.getTicketValues(tickets);


        Shareable shareable = new Ticket();
        shareable.sharedByEmail("JohnDoe@gmail.com");
        shareable.sharedByPhone("+1126295978");



        User client = new Client(8625);
        User admin = new Admin(1296);
        ...
        clients.getTicket(full);
        Admin administrator = new Admin();
        administrator.checkTicket(full);
